    ...
    function adding() {
        ...
        if (Count === 1) {
            glassImage.src = 'images/img2.png';
            button.innerText = 'Add Syrup';
        } 
        else if (Count === 2) {
            glassImage.src = 'images/img3.png';
            button.innerText = 'Add soda';
        } 
        else if (Count === 3) {
            glassImage.src = 'images/img4.png';
            button.innerText = 'Add Glitters!';
        } 
        else if (Count === 4) {
            glassImage.src = 'images/img5.png';
            button.innerText = 'Drink is ready!';
        }
        else if(Count === 5){
            glassImage.src = 'images/img1.png';
